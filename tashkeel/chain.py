...
from prompts import tashkeel_prompt, verification_prompt, whole_paragraph_organizer_prompt
import os, time, math
...
class TashkeelChain:
    ...
    def __call__(self):
        ...
        with open("paragraph_diacratized.txt",'w', encoding="utf-8") as f:
            f.write(result["combined_diacratized_text"].strip().strip('}'))
