...
json_parse_prompt = PromptTemplate(
    ...
    **النتيجة النهائية**:
    ...
    - تأكد من التراكيب الخاصة والتعابير الصعبة وتوضيحها بشكل جيد.
    - تأكد من أن النتائج مرتبة بشكل صحيح ومنظم.
    - تأكد من أن النتائج مكتملة وتحتوي على جميع الكلمات في الجملة وتحتوي على الإعراب الكامل
