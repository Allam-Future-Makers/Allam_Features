...
critic_prompt = PromptTemplate(
    template="""
    <s> [INST] أنت ناقد خبير في قواعد النحو العربي. مهمتك هي مراجعة نتائج الإعراب المقدمة للجملة والتأكد من دقتها بناءً على القواعد النحوية المعروفة والمعنى فى السياق. قم بما يلي:
...
فى أغلب الأحيان المعنى فى السياق يؤثر سلبا على الإعراب، لذلك يجب مراعاة ذلك.
مثال: أكل الطعام
الطعام مفعول به وليس فاعل
